...
import com.marveldemo.data.cache.AppDatabase
import com.marveldemo.data.cache.dao.HeroesDao
import com.marveldemo.data.cache.datasource.HeroLocalDataSourceImpl
...
import com.marveldemo.presentation.favorites.FavoriteHeroesScreenViewModel
...
val repositoryModule = module {
    ...
    single<HeroRepository> {
        HeroRepositoryImpl(
            ...
            heroLocalDataSource = HeroLocalDataSourceImpl(heroesDao = get())
        )
    }
}
...
val dataBaseModule = module {
    single {
        Room.databaseBuilder(androidApplication(), AppDatabase::class.java, "table_heroes")
